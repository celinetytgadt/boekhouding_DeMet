...
const INFO_TEKSTEN = {
  ...
  klantenLeveranciers: {
    ...
    regels: [
      ...
      "Heb je voor een betaalde factuur niet hetzelfde bedrag op D en C? Dan is de financiële korting waarschijnlijk vergeten of aan de verkeerde kant geboekt.",
